...
export default function Backdrop({ playful = false }: { playful?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {playful && (
        <div className="absolute bottom-[6%] left-[34%] z-10 hidden flex-col items-center sm:flex">
          <span
            className="anim-sway block select-none leading-none drop-shadow-md"
            style={{ fontSize: "248px", animationDuration: "5s" }}
          >
            🌳
          </span>
          <span
            className="-mt-14 h-52 w-12 rounded-b-md shadow-md"
